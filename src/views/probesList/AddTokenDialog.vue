<template>
  <el-dialog title="新建探针密签" visible width="500px" :close-on-click-modal="false" :before-close="close" append-to-body>
...
export default {
  ...
  methods: {
    ...
    save () {
      this.loading = true;
      this.$axios.post(this.$apis.tokenProbeCreate, this.form).then(res => {
        this.loading = false;
